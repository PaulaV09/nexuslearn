    ...
    <header class="hero">
        <nav class="nav container">
            ...
            <ul class="nav_link nav_link--menu">
                <li class="nav_items">
                    <a href="../vistas/index.php" class="nav_links">Inicio</a>
                </li>
                <li class="nav_items">
                    <a href="../vistas/login.php" class="nav_links">Iniciar Sesión</a>
                </li>
                <li class="nav_items">
                    <a href="../vistas/signin.php" class="nav_links">Registrarse</a>
                </li>
