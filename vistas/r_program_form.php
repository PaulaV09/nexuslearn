...
<body onload="if(performance.navigation.type == 2) location.reload();">
    ...
    <main>
        <div class="container-form">
            <div class="info-form">
                <h2>Comparte tus recursos académicos de programación</h2>
            ...
            <form action="../php/insertar_program.php" class="content-form" method="post" enctype="multipart/form-data">
                <div class="input-box">
                ...
                <div class="button-container button-cancelar">
                    <button type="button" onclick="window.location.href='r_program.php'">Cancelar</button>
                </div>
            </form>
        </div>
    </main>
