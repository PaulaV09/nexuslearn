...
$consulta = mysqli_query($conexion, "SELECT * FROM r_quimica");
...
<body>
    ...
    <section class="questions container">
            ...
            <p class="questions__paragraph">Aquí podrás encontrar libros, documentos, link, videos, etc sobre química</p>
            <div class="a_container">
                <a href="../nexuslearn/r_quimica_form.php" class="cta cta_repo">Subir recurso</a>
            </div>
                            ...
                            <table class="repositorio_table">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="6" class="td_row">
                                        <span class="td_download">
                                            <a href="../nexuslearn/php/download_quimica.php?archivo=<?php echo urlencode(basename($fila['archivo'])); ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="td_content td">
                                        ...
                                        $nombreArchivo = preg_replace('/^..\/files_quimica\/\d{2}-\d{2}-\d{2}-\d{2}-\d{2}-\d{2}-/', '', $archivoConFecha);
                                        echo $nombreArchivo;
                                        ?>
                                    </td>
                                </tr>
